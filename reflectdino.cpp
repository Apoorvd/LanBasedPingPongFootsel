...
int main(int argc, char** argv)
{
	...
	{
		cout << "Enter reflection axis ( input be like --- x then space then coord or y then space then coord ): "; cin >> reflectionAxis;
	}
	else if (choice == 5)
	{
		cout << "Enter shearing axis ( input be like x or y ): "; cin >> shearingAxis;
		if (shearingAxis == 'x' || shearingAxis == 'X')
		{
